...
Source de la visualisation et de l'analyse : **UPR – « France, République bananière : BFMTV et CNEWS prises en flagrant délit de "fake news" en truquant systématiquement en faveur de Macron les présentations visuelles des sondages »**, publiée le 25 août 2018.

L'article analyse notamment la présentation du sondage diffusé par BFMTV le **24 avril 2018**. Il indique que les résultats réels étaient de **48 % d'opposition, 37 % de soutien et 15 % d'indifférence**, alors que les proportions représentées dans le camembert ne correspondaient pas à ces valeurs. :contentReference[oaicite:0]{index=0}

[Consulter la source](https://upr.fr/analyses/fake-news-bfmtv-et-cnews-prises-en-flagrant-delit-de-truquer-systematiquement-en-faveur-de-macron-les-presentations-visuelles-des-sondages/)
...
L'article analyse la visualisation diffusée par BFMTV le **22 août 2018**. Les résultats du sondage étaient de **58 %** pour « elle dégrade », **36 %** pour « elle reste stable » et **6 %** pour « elle s'améliore ». L'analyse montre que les proportions du camembert diffusé ne correspondaient pas à ces pourcentages. :contentReference[oaicite:1]{index=1}
...
![Camembert corrigé du sondage CNEWS du 22 mai 2018](corrige_camembert_cnews_22_mai_2018.png)

Le graphique ci-dessus présente une correction de la visualisation diffusée sur CNEWS le 22 mai 2018.

Les résultats du sondage étaient :
- **49 %** des personnes interrogées étaient contre la mobilisation des fonctionnaires ;
- **40 %** étaient favorables à cette mobilisation ;
- **11 %** n'avaient pas d'avis.

Ces trois valeurs représentent bien **100 %** des réponses. Le camembert corrigé respecte donc les proportions réelles entre les différentes catégories.

Dans cette version, le secteur de **49 %** occupe presque la moitié du cercle. Le secteur de **40 %** est légèrement plus petit, ce qui correspond à l'écart réel entre les deux valeurs. Enfin, le secteur de **11 %** représente une petite partie du cercle, mais il reste clairement visible.

La comparaison avec la visualisation originale montre le problème : dans le graphique diffusé sur CNEWS, les secteurs ne correspondent pas correctement aux pourcentages affichés. La différence entre les **49 %** et les **40 %** paraît notamment beaucoup plus importante visuellement qu'elle ne l'est réellement, tandis que les **11 %** sont presque invisibles.

Le graphique corrigé permet donc au lecteur de comprendre immédiatement la répartition des réponses sans avoir à se fier uniquement aux chiffres écrits à côté du camembert.

Cet exemple montre qu'une visualisation peut être trompeuse lorsque les proportions graphiques ne correspondent pas aux données numériques. Pour qu'un camembert soit fiable, la taille de chaque secteur doit être proportionnelle à la valeur qu'il représente.

### Source

Source de la visualisation et de l'analyse : **UPR – « France, République bananière : BFMTV et CNEWS prises en flagrant délit de "fake news" en truquant systématiquement en faveur de Macron les présentations visuelles des sondages »**, publiée le 25 août 2018.

L'article analyse la visualisation diffusée par CNEWS le **22 mai 2018**, à partir d'un sondage Viavoice pour Le Figaro. Les résultats indiqués étaient de **49 %** contre la grève des fonctionnaires, **40 %** favorables et **11 %** sans opinion. L'analyse relève que les secteurs du camembert présenté à l'antenne ne respectaient pas ces proportions. :contentReference[oaicite:2]{index=2}
